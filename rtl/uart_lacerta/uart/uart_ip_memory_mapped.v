...
module uart_ip_memory_mapped #(parameter NUM_BYTES_DATA = 4, parameter NUM_BYTES_ADDRESS = 1)(
	...
	input wire [NUM_BYTES_DATA*8-1:0] mem_rdata,
	input wire mem_rdy,
...
uart_ip_memory_mapped_ctrl_fsm #(.NUM_BYTES_DATA(NUM_BYTES_DATA), .NUM_BYTES_ADDRESS(NUM_BYTES_ADDRESS)) uart_ip_memory_mapped_ctrl_fsm_i(
	.clk(clk),
	.arst_n(arst_n),
	.mem_we(mem_we),
	.mem_wdata(mem_wdata),
