module wb_top_2master_debug_tb;
...
initial begin
    ...
    cmd_addr_m1 = 16'h20FF;
    cmd_wdata_m1 = 32'h800000AC;
    cmd_we_m1 = 1'b1;
    cmd_valid_m1 = 1'b1;
    @(posedge clk);
    cmd_valid_m1 = 1'b0;
    ...
    cmd_addr_m1 = 16'h30FF;
    cmd_wdata_m1 = 32'h800000BA;
    cmd_we_m1 = 1'b1;
    cmd_valid_m1 = 1'b1;
    @(posedge clk);
    cmd_valid_m1 = 1'b0;
    ...
    cmd_addr_m1 = 16'h40FF;
    cmd_wdata_m1 = 32'h800000CA;
    cmd_we_m1 = 1'b1;
    cmd_valid_m1 = 1'b1;
    @(posedge clk);
    cmd_valid_m1 = 1'b0;
